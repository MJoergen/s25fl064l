...
--    V1.0       B.Barac         18 Feb 14   Initial release
-------------------------------------------------------------------------------
--  PART DESCRIPTION:
--
--  Description:
        ...
        CASE Series IS
            ...
            WHEN 7  => -- Read Memory Array commands
                CASE Testcase IS
                    ...
                    command_seq(3)  :=(rd     ,read    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(4)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    -- Fast Read
                    command_seq(5)  :=(fast_rd     ,read_fast    ,5,0,1,0,valid,0 ns);
                    command_seq(6)  :=(fast_rd     ,read_fast    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(7)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    -- Dual Output Read
                    command_seq(8)  :=(dual_output_rd     ,read_dual_O    ,5,0,2,0,valid,0 ns);
                    command_seq(9)  :=(dual_output_rd     ,read_dual_O    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(10)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    -- Dual IO Read
                    command_seq(11)  :=(dual_IO_rd     ,read_dual_IO    ,5,0,3,0,valid,0 ns);
                    command_seq(12)  :=(dual_IO_rd     ,read_dual_IO    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    ...
                    command_seq(11)  :=(quad_output_rd     ,read_quad_O    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(12)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    -- Quad IO Read
                    command_seq(13)  :=(quad_IO_rd     ,read_quad_IO    ,5,0,3,0,valid,0 ns);
                    command_seq(14)  :=(quad_IO_rd     ,read_quad_IO    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(15)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    -- Dual IO Continuous Read
                    ...
                    command_seq(3)  :=(ddr_quad_IO_rd ,read_ddr_quad_IO    ,10,0,16#7FF#,16#7FA#,valid,0 ns);
                    command_seq(4)  :=(idle   ,none   ,0,0,0,0,valid,0 ns);
            ...
            WHEN 8  => -- Program Flash Array commands
                CASE Testcase IS
                    ...
                    command_seq(17)  :=(rd     ,read    ,2,0,16#7FF#,16#7FA#,valid,0 ns);
            ...
            WHEN 9  => -- Erase Flash Array commands
                CASE Testcase IS
                    ...
                    command_seq(18)  :=(rd     ,read    ,2,0,16#7FF#,16#7FA#,valid,0 ns);
            ...
            WHEN 12  => -- Pointer Region Protect
                CASE Testcase IS
                    ...
                    command_seq(8)  :=(read_SR1   ,rd_wip_0 ,1,0,0,0,valid,0 ns);
                    -- Read Any Register from addresses 39h and 3Ah gives PRPR[15:8], PRPR[23:16]
                    command_seq(9)  :=(rdar       ,read_rdar ,1,0,0,16#39#,valid,0 ns);
                    command_seq(10) :=(rdar       ,read_rdar ,1,0,0,16#3A#,valid,0 ns);
                    -- Write Any Register command to addresses 39h and 3Ah sets PRPR[15:8], PRPR[23:16]
                    command_seq(11)  :=(w_enable   ,none    ,0,0,0,0,valid,0 ns);
                    command_seq(12)  :=(wrar       ,none ,1,16#02#,0,16#39#,valid,0 ns);
                    command_seq(13)  :=(wt         ,none     ,0,0,0,0,valid,tW);
                    command_seq(14)  :=(rdar       ,read_rdar ,1,0,0,16#39#,valid,0 ns);
                    command_seq(15)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
            ...
            WHEN 15  => -- Protection Register read and lock commands
                CASE Testcase IS
                    ...
                    command_seq(1)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
                    command_seq(2)  :=(w_enable   ,none    ,0,0,0,0,valid,0 ns);
                    command_seq(3)  :=(w_sprp     ,err    ,0,0,0,16#7F0000#,valid,0 ns);
                    command_seq(4)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
            ...
            WHEN 16  => -- Array write protection
                CASE Testcase IS
                    ...
                    command_seq(4)  :=(w_wrr,none ,1,16#24#,0,0,valid,0 ns);
                    command_seq(5)  :=(idle   ,none    ,0,0,0,0,valid,0 ns);
            ...
            WHEN 19  => -- Reset commands
                CASE Testcase IS
                    ...
                    command_seq(3)  :=(rd     ,read    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    command_seq(4)  :=(idle   ,none    ,0,0,0,0,DontAssertCSNeg,0 ns);
                    -- Fast Read
                    command_seq(5)  :=(fast_rd     ,read_fast    ,5,0,1,0,DontAssertCSNeg,0 ns);
                    command_seq(6)  :=(fast_rd     ,read_fast    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    ...
                    command_seq(9)  :=(dual_output_rd     ,read_dual_O    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    command_seq(10)  :=(idle   ,none    ,0,0,0,0,DontAssertCSNeg,0 ns);
                    -- Dual IO Read
                    command_seq(11)  :=(dual_IO_rd     ,read_dual_IO    ,5,0,3,0,DontAssertCSNeg,0 ns);
                    command_seq(12)  :=(dual_IO_rd     ,read_dual_IO    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    ...
                    command_seq(11)  :=(quad_output_rd     ,read_quad_O    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    command_seq(12)  :=(idle   ,none    ,0,0,0,0,DontAssertCSNeg,0 ns);
                    -- Quad IO Read
                    command_seq(13)  :=(quad_IO_rd     ,read_quad_IO    ,5,0,3,0,DontAssertCSNeg,0 ns);
                    command_seq(14)  :=(quad_IO_rd     ,read_quad_IO    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    ...
                    command_seq(3)  :=(ddr_quad_IO_rd ,read_ddr_quad_IO    ,10,0,16#7FF#,16#7FA#,DontAssertCSNeg,0 ns);
                    command_seq(4)  :=(idle   ,none   ,0,0,0,0,DontAssertCSNeg,0 ns);
                    -- DDR QUAD IO Continuous Read
